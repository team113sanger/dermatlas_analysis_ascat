...
# Check for tsv2xlsx.R script in either MAF or maf directory
CONVERT_SCRIPT=""
if [[ -e $PROJECTDIR/scripts/maf/tsv2xlsx.R ]]; then
    CONVERT_SCRIPT="$PROJECTDIR/scripts/maf/tsv2xlsx.R"
elif [[ -e $PROJECTDIR/scripts/MAF/tsv2xlsx.R ]]; then
    CONVERT_SCRIPT="$PROJECTDIR/scripts/MAF/tsv2xlsx.R"
fi
